...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[content/CS2106/L8]] | Base+Limit leads to **segmentation** — multiple base+limit pairs for different memory regions |
| [[content/CS2106/L9]] | Logical addresses enable **virtual memory** — pages can live anywhere, even on disk |
