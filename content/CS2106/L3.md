...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[content/CS2106/L1]] | OS structure — scheduler is part of the kernel |
| [[content/CS2106/L2]] | Process creation — scheduler picks from ready queue based on state |
| [[content/CS2106/L4]] | IPC — scheduling affects when processes can communicate (blocked on I/O) |
| [[content/CS2106/L5]] | Threads — same scheduling concepts apply to threads within processes |
| [[content/CS2106/L6]] | Synchronization — blocked processes waiting for semaphores go to Blocked state |
| [[L9]] | Working set — scheduler considers process memory footprint for frame allocation |
| [[L12]] | I/O scheduling — disk scheduling uses similar queue-based algorithms |
