...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[L1]] | OS structure — scheduler is part of the kernel |
| [[L2]] | Process creation — scheduler picks from ready queue based on state |
| [[L4]] | IPC — scheduling affects when processes can communicate (blocked on I/O) |
| [[L5]] | Threads — same scheduling concepts apply to threads within processes |
