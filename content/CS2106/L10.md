...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[L1]] | OS services — file system is a core OS abstraction for persistent storage |
| [[L2]] | Process context — file descriptors are part of the OS context |
| [[L3]] | Scheduling — I/O-bound processes spend time blocked on file operations |
| [[L4]] | IPC — pipes use file descriptors for communication |
