...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[L1]] | OS services — file system implementation is core kernel functionality |
| [[L2]] | File descriptors — per-process table maps fds to system-wide open file table |
| [[L3]] | I/O scheduling — disk scheduling (FCFS, SSF) similar to process scheduling |
| [[L4]] | Pipes — implemented via file system mechanisms |
