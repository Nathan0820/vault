...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[content/CS2106/L1]] | OS services — file system implementation is core kernel functionality |
| [[content/CS2106/L2]] | File descriptors — per-process table maps fds to system-wide open file table |
| [[content/CS2106/L3]] | I/O scheduling — disk scheduling (FCFS, SSF) similar to process scheduling |
| [[content/CS2106/L4]] | Pipes — implemented via file system mechanisms |
| [[content/CS2106/L6]] | Synchronization — concurrent file operations need locks |
| [[L7]] | Memory allocation — disk block allocation parallels memory allocation (contiguous vs. linked vs. indexed) |
| [[L8]] | Paging concepts — file buffer cache uses similar mechanisms |
| [[L9]] | Replacement algorithms — LRU/CLOCK apply to buffer cache |
| [[L10]] | File concepts — implementation details for files and directories |
| [[L12]] | Case studies — FAT and Ext2 are real implementations of these concepts |
