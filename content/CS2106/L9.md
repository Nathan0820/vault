...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[content/CS2106/L1]] | OS structure — VM manager is a core OS component |
| [[content/CS2106/L2]] | Memory context — logical address space may exceed physical memory |
| [[content/CS2106/L3]] | Scheduling — working set size affects frame allocation decisions |
| [[content/CS2106/L4]] | IPC — shared memory regions can be paged out |
| [[content/CS2106/L5]] | Threads — all threads share the same virtual address space |
| [[content/CS2106/L6]] | Synchronization — page table updates need atomicity in multiprocessors |
