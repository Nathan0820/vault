...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[content/CS2106/L1]] | OS structure — file systems are kernel services providing persistent storage |
| [[content/CS2106/L2]] | File descriptors — processes access files via fd table in OS context |
| [[content/CS2106/L3]] | I/O scheduling — disk scheduling affects file system performance |
| [[content/CS2106/L4]] | IPC — file-based communication (pipes) uses file system calls |
| [[content/CS2106/L6]] | Synchronization — concurrent file access needs locking mechanisms |
