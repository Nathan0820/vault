...
> [!tip] The Big Picture
> In [[content/CS2106/L7]], processes had to occupy one big, unbroken chunk of RAM. But what if we could **scatter** a process's memory across physical RAM? That's exactly what paging does.
...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[content/CS2106/L1]] | OS structure — memory management hardware (MMU, TLB) is part of the kernel |
| [[content/CS2106/L2]] | Memory context — segmentation provides separate regions for Text, Data, Stack, Heap |
| [[content/CS2106/L5]] | Threads — all threads share the same page table |
| [[content/CS2106/L6]] | Synchronization — multiprocessor systems need atomic page table updates |
...
| [[L10]] | Memory concepts — file buffer cache uses similar paging concepts |
