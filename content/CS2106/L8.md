...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[L1]] | OS structure — memory management hardware (MMU, TLB) is part of the kernel |
| [[L2]] | Memory context — segmentation provides separate regions for Text, Data, Stack, Heap |
| [[L5]] | Threads — all threads share the same page table |
