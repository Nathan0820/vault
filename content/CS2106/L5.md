...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[content/CS2106/L1]] | Kernel threads — OS schedules kernel threads; user threads are library-managed |
| [[content/CS2106/L2]] | Process context — threads share memory context, each has own hardware context |
| [[content/CS2106/L3]] | Scheduling — same scheduling concepts apply (Ready/Running/Blocked states) |
| [[content/CS2106/L4]] | IPC — threads within same process share memory, no IPC needed |
