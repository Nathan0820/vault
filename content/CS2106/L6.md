...
> <details><summary>Answer</summary>
>
> **Answer: D (The processes are in the same address space)**
>
...
> <details><summary>Answer</summary>
>
> **Answer: B (Context switches can occur between any two software instructions)**
>
...
> <details><summary>Answer</summary>
>
> **Answer: C (It wastes CPU cycles while waiting)**
>
...
> <details><summary>Answer</summary>
>
> **Answer: C (That writing to `Turn` is atomic)**
>
...
> <details><summary>Answer</summary>
>
> **Answer: B (Both set `Want[i] = 1` before either checks the while loop)**
>
...
> <details><summary>Answer</summary>
>
> **Answer: B (Producer-consumer signaling)**
>
...
> <details><summary>Answer</summary>
>
> **Answer: B (The buffer has K available slots initially)**
>
...
> <details><summary>Answer</summary>
>
> **Answer: B (`nReader` itself is a shared variable that can race)**
>
...
> <details><summary>Answer</summary>
>
> **Answer: B (Deadlock is possible again)**
>
...
> [!warning] macOS Semaphore Limitation
> On macOS (Apple Silicon), `sem_init` with `pshared=1` (shared between processes) is **unsupported**. Use `sem_open` instead.
