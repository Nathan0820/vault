...
| 📚 Lecture | 🔗 Connection |
| :--- | :--- |
| [[L1]] | OS services — synchronization primitives are kernel services |
| [[L2]] | Process context — shared resources require coordination |
| [[L3]] | Blocked state — processes waiting for semaphores go to Blocked |
| [[L4]] | IPC — shared memory IPC requires semaphore protection |
| [[L5]] | Threads — race conditions arise when threads share memory |
